...
public class DeleteCustomerAddressFromCustomerHandlerTests
{
    // [Fact]
    ...
    //     // ARRANGE
    //     var request = new DeleteCustomerAddressFromCustomerRequest()
    //     {
    ...
    //     // ACT
    //     var handler = new DeleteCustomerAddressFromCustomerHandler(mapper,mockRepository.Object);
